...
public class NormalFermentationRecipe extends BaseFermentationRecipe {
    ...
    public NormalFermentationRecipe(ResourceLocation id, int cookingTime, NonNullList<Ingredient> input, ItemStack output) {
    ...
    public static class Serializer implements RecipeSerializer<NormalFermentationRecipe> {
        @Override
        public NormalFermentationRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
            ...
            return new NormalFermentationRecipe(pRecipeId, cookingTime, input, output);
        }

        @Override
        public @Nullable NormalFermentationRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf pBuffer, NormalFermentationRecipe pRecipe) {
