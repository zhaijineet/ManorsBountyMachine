...
public class FastFryRecipeBuilder {
    ...
    public void save(Consumer<FinishedRecipe> pRecipeConsumer, ResourceLocation pLocation) {
        ResourceLocation recipePath = ResourceLocation.fromNamespaceAndPath(ManorsBountyMachine.MOD_ID, pLocation.withPrefix("fast_fry/").getPath());
        pRecipeConsumer.accept(new FastFryRecipeBuilder.Result(recipePath, this.input, this.output));
    }
