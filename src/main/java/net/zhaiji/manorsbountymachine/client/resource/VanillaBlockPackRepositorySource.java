...
@OnlyIn(Dist.CLIENT)
public class VanillaBlockPackRepositorySource implements RepositorySource {
    private static final String DIR_NAME = "manors_bounty-vanilla_blocks_add_item_textures";
    private static final String PACK_NAME = "vanilla_blocks_add_item_textures";
    private final Pack pack;

    public VanillaBlockPackRepositorySource() {
        ...
        this.pack = Pack.create(
                PACK_NAME,
                Component.literal("Manor's Bounty-Vanilla Add Item Textures"),
                false,
                supplier,
