...
/**
 * {@link CampfireSmokeParticle}
 */
@OnlyIn(Dist.CLIENT)
public class SteamParticle extends TextureSheetParticle {
    SteamParticle(ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed, boolean pSignal) {
    ...
    public static class CosyProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            SteamParticle steamParticle = new SteamParticle(pLevel, pX, pY + 0.4, pZ, pXSpeed, pYSpeed, pZSpeed, false);
